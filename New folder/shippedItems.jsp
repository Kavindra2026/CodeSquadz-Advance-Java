                    ...
                    <%
                        ...
                        for (OrderBean order : orders) {
                            ...
                            if (shipped == 2) {
                                ...
                                status = "UNKNOWN";
                                statusClass = "status-placed"; // Default class
                            }
